({
    init: function (cmp, event, helper) {
        ...
        var column6Label = cmp.get('v.column6_label');
        var column6FieldName = cmp.get('v.column6_fieldName');
        var column6Type = cmp.get('v.column6_type');

        cmp.set('v.mycolumns', [
            {label: column6Label, fieldName: column6FieldName, type: column6Type, initialWidth: 160, sortable: true},
            {label: column1Label, fieldName: column1FieldName, type: column1Type, initialWidth: 160, sortable: true},
            {label: column5Label, fieldName: column5FieldName, type: column5Type, initialWidth: 160, sortable: true},
